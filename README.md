...
# How it works
This will detect motion using SR501, if any motion is detected, the system will check temperature and light conditions, light and fan will be turned on if the conditions is matched. After that, the data including humidity, light, temperature, led status, fan status will be sent to Blynk
